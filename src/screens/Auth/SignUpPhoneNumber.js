                  ...
                  await registerPatient({
                    variables: {
                      firstName:
                        ...
                        item.item.firstName.toLowerCase().substring(1),
                      lastName:
                    ...
                    .then(async res => {
                      if (res.data.registerPatient.token) {
                        await AsyncStorage.setItem(
                          AUTH_TOKEN,
                          res.data.registerPatient.token,
                        );
                        await AsyncStorage.setItem(
                          FIRST_NAME,
                          item.item.firstName.charAt(0).toUpperCase() +
                        ...
                        await AsyncStorage.setItem(EMAIL, item.item.email);
                        sendPhoneVerification()
                          .then(res => {
                            const {
                              code,
